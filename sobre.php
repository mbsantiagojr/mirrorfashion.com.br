<?php include 'header.php'; ?>
	...
	<main class="container" id="sobre">
		...
		<p>
			Nosso centro de distribuição fica em <a class="link-texto" href="https://goo.gl/maps/tQq9R">Jacarezinho</a>, no Paraná. De lá, saem 48 aviões que 
		...
		<p>Compre suas roupas e acessórios na Mirror Fashion. Acesse <a class="link-texto" href="index.html">nossa loja </a>ou entre em contato 
		se tiver dúvidas.</p>
		<p>Conheça também <a class="link-texto" href="#hist">nossa história</a> e <a class="link-texto" href="#dif">nossos diferenciais</a>.</p>
